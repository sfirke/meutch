...
- Add "vacation mode" toggle to user profile ([#147]). When enabled, it hides user's items from being discovered (existing loans persist).
- Implement user requests ([#176](https://github.com/sfirke/meutch/pull/176))
