...
- Links in messages are now clickable in the conversation view and in message notification emails — previously a URL someone sent you had to be copied and pasted. Message text is also now properly escaped wherever it is displayed ([#412](https://github.com/sfirke/meutch/pull/412)).
