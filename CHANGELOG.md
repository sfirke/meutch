...
- Links in request and item descriptions are now clickable — in the home feed and on the request and item detail pages ([#472](https://github.com/sfirke/meutch/pull/472)).
