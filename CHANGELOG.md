...
### Bug fixes
- The person selected to receive a giveaway now sees that on the item page. Previously everyone but the owner — the selected recipient included — was told "This giveaway is pending pickup by another user", so the one person who needed to arrange pickup was told the item had gone to someone else ([#475](https://github.com/sfirke/meutch/pull/475)).
