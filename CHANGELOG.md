...
**Minor**:
- Improved the giveaway handoff experience so item owners can close the loop even when a requester messages instead of clicking "I Want This!" - also allows for giveaways given outside of Meutch (XXX)
