...
- Add the first reusable API foundation layer: structured JSON error handling, shared pagination helpers, and Marshmallow boundary schemas for upcoming read endpoints.
