...
### Bug fixes
- The "View Item Details" button in overdue loan reminder emails now takes you to the message thread for that loan, where you can see its status and reply to the other person, instead of to the item page which does not show the loan at all ([#479](https://github.com/sfirke/meutch/pull/479)).
