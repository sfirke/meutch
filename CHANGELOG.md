...
- Add JWT-backed `/api/v1/auth` endpoints with access/refresh tokens, refresh rotation and revocation, current-user identity, and mobile-facing register/reset workflows.
