...
- Links are now clickable wherever text you wrote is shown in full: request and item descriptions (home feed, detail pages, and public share pages), circle descriptions, profile bios, and the message attached to a giveaway request. URLs written without a scheme, like `www.example.com`, are linked too ([#472](https://github.com/sfirke/meutch/pull/472)).
