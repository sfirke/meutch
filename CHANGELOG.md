...
- Extract shared read-side query helpers for item discovery, messaging inboxes/threads, request visibility, and circle browse/detail views so future API endpoints can reuse the web app's visibility and pagination rules.
