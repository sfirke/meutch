...
### Bug fixes
- Giveaways listed as "Circles only" are now actually limited to your circles on the item page itself. Browse, search, and the home feed already respected that setting, but anyone signed in who had the link could open the item page for a circles-only giveaway. People who already expressed interest, and the person selected to receive the item, keep their access even if they later leave the circle you share.
