...
# Pillow decoders tried on uploads, matching the extensions above. 'JPEG' also covers
# the multi-picture (MPO) JPEGs some phone cameras produce. Keeping every other decoder
# unreachable shrinks exposure to Pillow's decoder vulnerabilities.
...
MAX_SOURCE_IMAGE_PIXELS = (
    MAX_SOURCE_IMAGE_SIDE_LENGTH * MAX_SOURCE_IMAGE_SIDE_LENGTH
)  # 100 megapixels, to prevent decompression bombs
MAX_SOURCE_IMAGE_LABEL = f"{MAX_SOURCE_IMAGE_PIXELS // 1_000_000} megapixels"
MAX_SOURCE_IMAGE_EXAMPLE_DIMENSIONS = (
    f"{MAX_SOURCE_IMAGE_SIDE_LENGTH} x {MAX_SOURCE_IMAGE_SIDE_LENGTH}"
)
