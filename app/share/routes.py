...
from app.models import Circle, Item, ItemRequest
...
from app.utils.item_share import (
    ITEM_SHARE_TOKEN_MAX_AGE_DAYS,
    build_item_share_url,
    verify_item_share_token,
)
...
def generate_item_link(item_id):
    ...
    share_url = build_item_share_url(item)
